    ...
    <section id="newsfeed" class="space-y-6">
        @foreach ($posts as $post)
            <article class="bg-white border-2 border-black rounded-lg shadow mx-auto max-w-none px-4 py-5 sm:px-6">
                ...
                <!-- Content -->
                <a href="{{ route('feed.single', $post->id) }}">
                    <div class="py-4 text-gray-700 font-normal">
                        ...
                        @endif
                        <p>
                            {!! nl2br(wrapHashTagsByUrl($post->description)) !!}
                        </p>
                    </div>
                </a>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex gap-8 text-gray-600">
                            ...
                            @php
                                // dump($postLikes);
                                // dd($post->id);
                                $liked = $postLikes->contains('post_id', $post->id);
                            @endphp
                            @livewire('like-action', key('like-action-livewire-{{ $post->id }}'), ['post' => $post, 'noOfLikes' => $post->likes_count, 'likedBefore' => $liked])

                            <!-- /Heart Button -->
                            <!-- Comment Button -->
                            <a href="{{ route('feed.single', $post->id) }}" type="button"
